...
, function(module, exports, __webpack_require__) {
    ...
    _libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : {
        pdfJsWorker: "http://kuzhithuraidiocese.com/assests/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    }).pdfJsWorker,
    ...
    __webpack_require__(65))
      ...
      , BookView = function(_View) {
        ...
        BookView.prototype.getTemplate = function() {
            return {
                html: admin_url+"assests/templates/default-book-view.html",
                styles: [admin_url+"assests/css/black-book-view.css"],
                links: [{
                    rel: "stylesheet",
                    href: admin_url+"assests/css/font-awesome.min.css"
                }],
                script: admin_url+"assests/js/default-book-view.js"
            }
        }
        ,
        BookView
