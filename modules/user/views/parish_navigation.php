	...
	<div class="jumbotron" style="background:url(<?php echo base_url('uploads/parish/' . imageCheck('parish', $page['cimg'])); ?>) center center no-repeat;background-size:cover;-webkit-background-size:cover;background-position:fixed;padding-top:240px;padding-bottom:0;margin-bottom:0;width:100%"></div>
		...
		<div class="row" style="position:absolute;bottom:0;width:100%">
			<div>
				<div class="col-sm-2 nomargin relative">
					<?php if(isset($parish_access) && in_array($this->session->userdata('userID'), $parish_access) ) { ?>
					<form id="photoUpload" action="<?php echo base_url('user/uploads/photo/parish'); ?>" method="post" enctype="multipart/form-data">
						<div data-provides="fileupload" class="btn btn-file fileupload fileupload-new userImage" style="padding:0">
							<div class="fileupload-new" style="overflow:hidden">
								<div class="col-xs-6 col-xs-offset-3 col-sm-12 col-sm-offset-0 text-center" style="padding:0">
									<div class="rounded full-round image-paren" style="border:6px solid #eee;overflow:hidden">
										<img id="userfile_preview" src="<?php echo base_url('uploads/parish/' . imageCheck('parish', $page['cimg'])); ?>" class="img-rounded img-bordered" style="width:100%" alt="" />
					...
					<div class="userImage">
						<div class="col-xs-6 col-xs-offset-3 col-sm-12 col-sm-offset-0 text-center" style="padding:0">
							<div class="rounded full-round image-parent" style="border:6px solid #eee;overflow:hidden">
								<?php echo '<img src="' . base_url('uploads/parish/' . imageCheck('parish', $page['cimg'])) . '" class="image-rounded img-bordered" style="width:100%" alt="" />'; ?>
							</div>
						</div>
					</div>
