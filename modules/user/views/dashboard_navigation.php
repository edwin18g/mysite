				<div class="row">
					<div class="col-sm-12">
						<div class="list-group">
							...
							<a href="<?php echo base_url('user/dashboard'); ?>" class="ajaxloads list-group-item<?php if($this->uri->segment(2) == '' || $this->uri->segment(2) == 'dashboard') echo ' active'; ?>"><i class="fa fa-dashboard"></i> &nbsp; <?php echo phrase('dashboard'); ?></a>
						...
						<div class="list-group">
							...
							<a href="<?php echo base_url('user/translate'); ?>" class="ajaxloads list-group-item<?php if($this->uri->segment(2) == 'translate') echo ' active'; ?>"><i class="fa fa-language"></i> &nbsp; <?php echo phrase('translate'); ?></a>
							
							<?php endif; ?>
							
							<a href="<?php echo base_url('user/edit_profile'); ?>" class="ajaxloads list-group-item<?php if($this->uri->segment(2) == 'edit_profile') echo ' active'; ?>"><i class="fa fa-cogs"></i> &nbsp; <?php echo phrase('edit_profile'); ?></a>
							
							<a href="<?php echo base_url('user/logout'); ?>" class="ajaxloads list-group-item"><i class="fa fa-sign-out"></i> &nbsp; <?php echo phrase('logout'); ?></a>
