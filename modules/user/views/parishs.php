	...
	<?php
		...
		include 'parish_navigation.php';
	?>
	<div class="container">
		<div class="row">
			<div class="col-md-3   sticky card" style="background:#fff;">
				<h4 class="sub-head"><i class="fa fa-info-circle"></i> <?php echo 'About '.$page['cname']; ?></h4>
				<!-- <p class="text-muted">
					<i class="fa fa-quote-left"></i> < ?php echo $page['bio']; ?>
				</p> -->
				<ul class ="list-group">
					<li class="list-group-item"> <span class="Ul-left"><i class="fa fa-angle-double-right"></i> <?php echo ' Est. Year' ?>   </span><br><span class="Ul-right"><?php echo ($page['estd'] != null)?$page['estd']:'-' ; ?></span></li>
					<li class="list-group-item"> <span class="Ul-left"><i class="fa fa-angle-double-right"></i> <?php echo ' Substations' ?>   </span><br><span class="Ul-right"><?php echo ($page['substation'] != null)?$page['substation']:'-' ; ?></span></li>
				<li class="list-group-item"> <span class="Ul-left"><i class="fa fa-angle-double-right"></i> <?php echo ' Anbiyam' ?>   </span><br><span class="Ul-right"><?php echo ($page['anbiyam'] != null)?$page['anbiyam']:'-' ; ?></span></li>	
				<li class="list-group-item"> <span class="Ul-left"><i class="fa fa-angle-double-right"></i> <?php echo ' Pious' ?>   </span><br><span class="Ul-right"> <?php echo ($page['pious'] != null)?$page['pious']:'-' ; ?></span></li>	
				<li class="list-group-item"> <span class="Ul-left"><i class="fa fa-angle-double-right"></i> <?php echo ' Institution' ?>   </span><br><span class="Ul-right"> <?php echo ($page['institution'] != null)?$page['institution']:'-' ; ?></span></li>	
				</ul>
