	...
	<div class="container">
		...
		<?php } ?>
		<div class="row">
			<div class="col-sm-4 nomargin-xs nopadding-xs col-sm-offset-4">
				<div class="image-placeholder-sm">
					<div class="col-sm-12 nomargin text-center">
						<div class="gap-sm"></div>
						<form action="<?php echo base_url('user/login'); ?>" method="post" class="submitForms" data-save="<?php echo phrase('sign_in'); ?>" data-saving="<?php echo phrase('signing_in'); ?>" data-alert="<?php echo phrase('unable_to_signing_in'); ?>">
					...
					<div class="col-sm-5 nomargin loginBorder hidden">
						<div class="gap-sm"></div>
						<div class="gap-sm"></div>
