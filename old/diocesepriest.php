	...
	<?php
	$id=$_GET['id'];
	$sql = "SELECT * FROM diocesepriest where priestid=".$id;
...
<table>
	...
	<?php if($row['priestid']!=null){?>
	<tr><td>Priest ID:</td><td><?php echo $row['priestid']; ?></td></tr>
	<?php }?>
...
<div class="whitebg1 contact">
				...
				<?php if($row['paddress']!=null){?>
							<b><p>Present Address:</p></b><p><span><?php echo $row['paddress']; ?></span></p>
							<?php }?>
				<?php if($row['nadd1']!=null){?>
							<b><p>Native Address:</p></b><p><span><?php echo $row['nadd1']; ?></span><br>
<span><?php echo $row['nadd2']; ?></span><br><span><?php echo $row['nadd3']; ?></span></p>
							<?php }?>
							<?php if($row['pphone']!=null){?>
							<b><p>Phone:</p></b><p><span><?php echo $row['pphone']; ?></span></p>
							<?php }?>
							<?php if($row['pmobile']!=null){?>
                                                        <b><p>Mobile:</p></b><p><span>+91-<?php echo $row['pmobile']; ?></span></p>
							<?php }?>
