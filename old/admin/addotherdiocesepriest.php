...
if(isset($_POST["save"]))
	...
	$sql = "insert into odiocesepriest(priestid,pname,pfname,pmnane,pdob,pplace,pseminary,porddate,pordplace,pordby,pminstring,paddress,pemail,pphone,contract,pimg) values('$priestid','$pname','$pfname','$pmnane','$pdob','$pplace','$pseminary','$porddate','$pordplace','$pordby','$pminstring','$paddress','$pemail','$phone','$contract','$priestid.jpg')";
	$val=$conn->query($sql);
	if($val)
	{
	header("Location:viewotherdiocesepriest.php?msg=2");
	exit();
	}
	}
?>
