...
var y = document.forms["myForm"]["priestid"].value;
	...
	$sql = "update diocesepriest set priestid='$priestid',pname='$pname',pminstring='$pminstring',pfname='$pfname',pmnane='$pmnane',pdob='$pdob',pplace='$pplace',pseminary='$pseminary',porddate='$porddate',pordplace='$pordplace',pordby='$pordby',paddress='$paddress',nadd1='$nadd1',nadd2='$nadd2',nadd3='$nadd3',bloodg='$bloodg',pemail='$pemail',pphone='$pphone',pmobile='$pmobile' where id=".$cid;
	
	$val=$conn->query($sql);
	if($val)
	{
	header("Location:viewdiocesepriest.php?msg=1");
	exit();
	}
	...
	$id=$_GET['id'];
	$sql = "SELECT * FROM diocesepriest where id=".$id;
...
<div class="col-md-3">
<p>Blood Group</p>
	<p><input type="text" name="bloodg" class="form-control" value="<?php echo $row['bloodg']; ?>"></p>
</div>
...
<p>Phone</p>
	<p><input type="text" name="pphone" class="form-control" value="<?php echo $row['pphone']; ?>"></p>
<p>Mobile</p>
	<p><input type="text" name="pmobile" class="form-control" value="<?php echo $row['pmobile']; ?>"></p>
...
<div class="col-md-3">
<p>Native Address</p>
	<p><input type="text" name="nadd1" class="form-control" value="<?php echo $row['nadd1']; ?>"></p>
	<p><input type="text" name="nadd2" class="form-control" value="<?php echo $row['nadd2']; ?>"></p>
	<p><input type="text" name="nadd3" class="form-control" value="<?php echo $row['nadd3']; ?>"></p>
</div>
